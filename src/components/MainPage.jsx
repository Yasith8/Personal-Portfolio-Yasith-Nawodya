...
function MainPage() {
  ...
  return (
    <section className='md:px-[15rem] h-screen flex flex-col justify-center ' id='home'>
      <motion.div
      ...
      <motion.div className='font-bold text-[1.5rem] md:text-[3rem] text-white flex flex-col items-center justify-center'
      ...
      >
        ...
        <h1 className='text-center' style={{ zIndex: 1 }}>Full Stack Developer Based on Sri Lanka</h1>
      </motion.div>
      <div className='flex items-center justify-center'>
        <div className='w-[5rem] h-[5rem] md:w-[25rem] md:h-[25rem] bg-[#64403b] rounded-full blur-[10rem] absolute top-5 left-1rem md:top-16 md:left-[50rem]' style={{ zIndex: 0 }}></div>
        <div className='w-[5rem] h-[5rem] md:w-[25rem] md:h-[25rem] bg-[#422277] rounded-full blur-[10rem] absolute top-5 left-5rem md:top-16 md:left-[30rem]' style={{ zIndex: 0 }}></div>
      </div>
